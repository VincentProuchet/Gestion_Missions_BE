...
public abstract class ErrorCodes {
    ...
    public static String collaboratorNotFound = "COLLABORATOR_NOT_FOUND";
    public static String expenseNotFound = "EXPENSE_NOT_FOUND";
    public static String expenseTypeNotFound = "EXPENSE_TYPE_NOT_FOUND";
    public static String managerNotFound = "MANAGER_NOT_FOUND";
    public static String natureCantBeDeleted = "INVALID_NATURE_DELETE";
